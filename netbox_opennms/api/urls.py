...
router.register("metadata-contexts", views.MetadataContextViewSet)
router.register("metadata-keys", views.MetadataKeyViewSet)
router.register("metadata-entries", views.MetadataEntryViewSet)
router.register("categories", views.CategoryViewSet)
router.register("metadata-pull-mappings", views.MetadataPullMappingViewSet)
